  ...
  return (
    <div className="h-screen w-full p-6 flex flex-col">
      ...
      <div className="h-16 border-t border-border flex flex-col item-center justify-center">
        <button className="h-full w-full mt-4 px-4 flex items-center rounded-md text-secondary transition-colors duration-200 hover:bg-secondary/10 cursor-pointer">
